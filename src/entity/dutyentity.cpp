#include "dutyentity.h"
DutyEntity::DutyEntity() : Entity("erp_duties"), mtable("erp_duties")
{

}

ErpSqlTableModel* DutyEntity::getAll()
{
...
QMap<QString, QVariant> DutyEntity::getOne(int id)
{
...
bool DutyEntity::insert(QMap<QString, QVariant>& data)
{
    QSqlTableModel model;
    model.setTable(mtable);
...
bool DutyEntity::update(QMap<QString, QVariant> &data, int id)
{
    QSqlTableModel model;
    model.setTable(mtable);
    model.setFilter(QObject::tr("id = %1").arg(id));
